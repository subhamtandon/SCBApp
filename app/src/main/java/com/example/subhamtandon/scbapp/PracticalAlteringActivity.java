...
public class PracticalAlteringActivity extends AppCompatActivity {
                ...
                if (pdfUri != null){
                    ...
                    if(ready.equals("true")) {
                        if(uploadTask != null && uploadTask.isInProgress()){
                            Toast.makeText(PracticalAlteringActivity.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            uploadFile(pdfUri);
                        }
    ...
    private void uploadFile(Uri pdfUri) {
        ...
        uploadTask = storageReference.child("Uploads").child(professional).child(subject).child("Practicals").child(fileName).putFile(pdfUri)

...
public class AdapterForUserPYQs extends RecyclerView.Adapter<AdapterForUserPYQs.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        File file = context.getFileStreamPath(subject+"PYQ"+arrayList.get(position));
        if (file.exists()){
        ...
        holder.textViewPYQName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                File file = context.getFileStreamPath(subject+"PYQ"+arrayList.get(position));
                if (file.exists()){
                    openPdf(subject+"PYQ"+arrayList.get(position));
                }else {
    ...
    private void downloadPdf(final String s, final int pos, final AdapterForUserPYQs.ViewHolder hold) {
        new AsyncTask<Void, Integer, Boolean>(){
            ...
            private Boolean downloadPdf(){
                try{
                    File file = context.getFileStreamPath(subject + "PYQ" + s);
                    if (file.exists())
                        return true;

                    try {
                        FileOutputStream fileOutputStream = context.openFileOutput(subject + "PYQ" + s, Context.MODE_PRIVATE);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView textViewPYQName,textView;
